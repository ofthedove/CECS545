...
namespace CECS545AI_Project1Combs
{
    class TSP_DepthFirst
    {
        ...
        public TSP_DepthFirst(string inputDataString, string connectionsDataString, OutputLog outputLogParam) : this(parseInputString(inputDataString), outputLogParam) { }
