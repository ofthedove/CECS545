...
namespace CECS545AI_Project1Combs
{
    class TSP_BreadthFirst
    {
        ...
        public TSP_BreadthFirst(string inputDataString, string connectionsDataString, OutputLog outputLogParam) : this(parseInputString(inputDataString, connectionsDataString), outputLogParam) { }
